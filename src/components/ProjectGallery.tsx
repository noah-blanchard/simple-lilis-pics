...
export function ProjectGallery({ project }: ProjectGalleryProps) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-ink text-fg">
      {/* ── Top bar ── */}
        ...
        {count > 1 && (
          <>
            <button
              ...
              className="-translate-y-1/2 absolute top-1/2 left-3 inline-flex h-12 w-12 items-center justify-center rounded-full border border-line bg-ink/30 text-fg/80 backdrop-blur transition-colors hover:bg-inverse hover:text-on-inverse md:left-6"
            >
            ...
            <button
              ...
              className="-translate-y-1/2 absolute top-1/2 right-3 inline-flex h-12 w-12 items-center justify-center rounded-full border border-line bg-ink/30 text-fg/80 backdrop-blur transition-colors hover:bg-inverse hover:text-on-inverse md:right-6"
            >
      ...
      <footer className="px-6 pt-4 pb-6 md:px-10 md:pb-8">
        <div className="flex flex-wrap items-end justify-between gap-x-8 gap-y-3">
          ...
          {project.year && (
            <span className="tag-mono shrink-0 text-fg/45">{project.year}</span>
          )}
        </div>
